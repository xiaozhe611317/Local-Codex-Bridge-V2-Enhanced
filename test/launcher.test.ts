...
macTest("Finder launcher sources do not contain author-specific executable paths", () => {
...
macTest("Finder bundle is signed universal Mach-O with the declared macOS 12 target", () => {
...
macTest("Finder app exits promptly while its detached Tunnel launcher continues", async () => {
...
macTest("production launcher passes the runtime key to Tunnel only through its environment", () => {
...
macTest("launcher lock is held across Tunnel exec and released on process exit", async () => {
